...
(function() {
  ...
  window.RecursiveHighlighter = (function() {
    ...
    RecursiveHighlighter.prototype.markHighlight = function(relativeBounds) {
      var domTree, hlEnd, hlStart, inserting, node, nodeEnd, nodeHlEnd, nodeHlStart, nodeLength, nodeRange, nodeStart, _i, _j, _len, _results, _results1;
      ...
      for (_i = 0, _len = domTree.length; _i < _len; _i++) {
        ...
        nodeRange = (function() {
          _results1 = [];
          for (var _j = nodeStart; nodeStart <= nodeEnd ? _j <= nodeEnd : _j >= nodeEnd; nodeStart <= nodeEnd ? _j++ : _j--){ _results1.push(_j); }
          return _results1;
        }).apply(this);
        if (__indexOf.call(nodeRange, hlStart) >= 0 || __indexOf.call(nodeRange, hlEnd) >= 0) {
        ...
        _results.push(nodeStart = nodeEnd);
      }
      return _results;
    };
